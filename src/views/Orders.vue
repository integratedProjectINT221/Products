  ...
  <div id="brands-page" class="w-screen flex justify-center">
    ...
    >
      <div v-for="brand in brands" :key="brand.id" id="loopbrands">
        <div class="bg-gray-300 h-40 w-40 hover:bg-gray-400 flex justify-center items-center group transition duration-100 cursor-pointer">
            <div class="text-gray-800 text-2xl font-medium group-hover:text-white transition duration-75 cursor-pointer">{{brand.brandName}}</div>
        </div>
      </div>
    </div>
  </div>
